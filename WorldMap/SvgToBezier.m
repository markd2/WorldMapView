...
//  More tweaking, hack for absolute coordinates, and ARC conversion - Mark Dalrymple 11 April 2012
//
...
- (CGPoint)bezierPoint:(CGPoint)svgPoint
{
    // I want absolute coordinates, not mapped to a particular rect, so
    // just bail out.  ++md
    return svgPoint;
